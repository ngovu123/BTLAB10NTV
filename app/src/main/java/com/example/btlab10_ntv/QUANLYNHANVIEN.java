package com.example.btlab10_ntv;
...
import com.example.btlab10_ntv.Database.NhanVienDatasource;
import com.example.btlab10_ntv.Database.PhongBanDataSource;

import java.util.ArrayList;
import java.util.List;

public class QUANLYNHANVIEN extends AppCompatActivity  implements TextWatcher {
...
//        loadEmployeeData();
    ...
    private void doEditEmployee(){
        if (vitrichon != -1 && vitrichon < arrayList.size()) {
            ...
            startActivityForResult(intent, QUANLYNHANVIEN.EDIT_EMPLOYEE);
        }
    }

    private void doNewEmployee() {
        Intent intent = new Intent(this, ThemNhanVienMoi.class);
        startActivityForResult(intent,QUANLYNHANVIEN.NEW_EMPLOYEE);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @NonNull Intent data) {
        ...
        switch (requestCode) {
            case QUANLYNHANVIEN.NEW_EMPLOYEE:
                if (resultCode == QUANLYNHANVIEN.SAVE_NEW_EMPLOYEE)
                {
                ...
                break;
            case QUANLYNHANVIEN.EDIT_EMPLOYEE:
                if (resultCode == QUANLYNHANVIEN.SAVE_EDIT_EMPLOYEE) {
                    Bundle b = data.getExtras();
